...
open class BookshelfFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        addBookFromUrl("https://fehrescdn.fra1.digitaloceanspaces.com/full_books/SXLWukUVTXNv1majo7owg0WHu7SyuJhtSCQxJsL4.epub")
//        addBookFromUrl("https://fehrescdn.fra1.digitaloceanspaces.com/full_books/5dfeebb5b35950b6d9d1695aa5a674c4.epub")
        return binding.root
    }

    open fun addBookFromUrl(urlString: String) {
        val absoluteUrl = AbsoluteUrl(urlString)

        // Check if the AbsoluteUrl is valid before proceeding
        if (absoluteUrl != null) {
            // Add the book using the valid AbsoluteUrl
            bookshelfViewModel.addPublicationFromWeb(absoluteUrl)
//            bookshelfViewModel.openPublication(1)
        } else {
